...
export const CompanyIntro: React.FC = () => {
    return (
        <div className="bg-white min-h-screen">
            <Seo
                title="회사소개 | 행사어때"
                description="행사어때는 대전·충청권 MICE 행사 운영 경험을 바탕으로 기획, 장비 렌탈, 공간 연출, 운영 지원을 통합 제공하는 플랫폼입니다."
                canonical="/company"
            />
            ...
            <div className="relative py-24 bg-slate-900 text-white overflow-hidden">
                ...
                <Container className="relative z-20 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{ lineHeight: 1.4 }}>
                        고객의 성공적인 행사를 위한<br />
                        <span className="text-[#39B54A]">최고의 파트너</span>
                    </h1>
                    <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto break-keep leading-relaxed">
                        행사어때는 공공기관과 기업 행사의 운영 경험을 바탕으로<br className="hidden md:block" /> 표준화된 행사 환경과 통합 운영 서비스를 제공합니다.
                    </p>
                </Container>
            </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                        <div className="flex-1">
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6 break-keep">
                                ABOUT <span className="text-[#39B54A]">행사어때</span>
                            </h2>
                            <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-6 break-keep">
                                행사어때는 공공기관과 기업 행사의 실질적인 운영 경험을 바탕으로<br className="hidden md:block" /> 설계된 행사 통합 운영 플랫폼입니다.
                            </p>
                            <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-6 break-keep">
                                10년 이상 축적된 현장 노하우를 기반으로,<br className="hidden md:block" /> 행사 준비 과정에서 발생하는 비효율과 협업의 어려움을<br className="hidden md:block" /> 패키지화·표준화하여 제공합니다.
                            </p>
                        ...
                        <div className="flex-1 grid grid-cols-2 gap-4">
                            <div className="bg-slate-50 p-6 rounded-lg text-center hover:shadow-lg transition-all border border-slate-100 flex flex-col items-center justify-center">
                                <LayoutTemplate className="w-10 h-10 text-[#39B54A] mb-3" />
                            ...
                            <div className="bg-slate-50 p-6 rounded-lg text-center hover:shadow-lg transition-all border border-slate-100 flex flex-col items-center justify-center">
                                <Network className="w-10 h-10 text-[#39B54A] mb-3" />
