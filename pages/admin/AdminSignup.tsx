                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-100 p-8">
                    <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        required
                                        className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#39B54A] focus:border-transparent outline-none transition-all pr-10"
                                        placeholder="8자 이상"
                                    />
                                    <button
                                        type="button"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 bg-[#39B54A] text-white rounded-lg font-semibold hover:bg-[#2F9A3F] disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
                        >
                            {loading ? (
                                <>
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-200">
                        <p className="text-center text-sm text-gray-600">
                            이미 계정이 있으신가요?{' '}
                            <Link to="/admin/login" className="text-[#39B54A] font-semibold hover:underline">
                                로그인
                            </Link>
                        </p>
                    </div>
